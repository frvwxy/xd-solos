...
When a non-bot member joins, the bot posts a light-blue welcome embed in channel `1547022446748508210`. Its **Verify** link button opens channel `1551336698003066980`. This is a server-channel post, not a DM. No new environment variable is needed. If posting fails, check the bot logs, welcome-channel permissions, and Server Members Intent setting.
